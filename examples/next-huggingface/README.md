# Khulnasoft AI SDK, Next.js, and Hugging Face Chat Example
...
To learn more about Hugging Face, Next.js, and the Khulnasoft AI SDK take a look at the following resources:
