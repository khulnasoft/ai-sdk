# KhulnaSoft AI SDK, Next.js, LangChain, OpenAI Chat Example

This example shows how to use the [KhulnaSoft AI SDK](https://ai.khulnasoft.com/docs) with [Next.js](https://nextjs.org/), [LangChain](https://js.langchain.com), and [OpenAI](https://openai.com) to create a ChatGPT-like AI-powered streaming chat bot.
...
```bash
npx create-next-app --example https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-langchain next-langchain-app
```

```bash
yarn create next-app --example https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-langchain next-langchain-app
```

```bash
pnpm create next-app --example https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-langchain next-langchain-app
```
...
- [KhulnaSoft AI SDK docs](https://ai.khulnasoft.com/docs) - learn mode about the KhulnaSoft AI SDK
