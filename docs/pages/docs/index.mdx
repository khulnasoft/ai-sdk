  ...
  <ExampleCard
    ...
    description={
      <>
        ...
        <A href="https://ai.khulnasoft.com">KhulnaSoft AI SDK</A>, and{' '}
  ...
  <ExampleCard
    ...
    description={
      <>
        ...
        <A href="https://ai.khulnasoft.com">KhulnaSoft AI SDK</A>
      </>
    }
...
{<div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-8">
  ...
  <IntegrationCard href="/docs/guides/providers/replicate" title="Replicate" description="Replicate an on-demand AI model hosting platform. The KhulnaSoft AI SDK provides a simple way to use Replicate models in your frontend web applications." />
