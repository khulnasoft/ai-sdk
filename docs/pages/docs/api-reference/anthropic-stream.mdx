...
This works with the official Anthropic API endpoint via the `fetch` standard, and it's supported in both Node.js, [Edge Runtime](https://edge-runtime.khulnasoft.app), and browser environments.
