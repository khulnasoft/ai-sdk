...
The Khulnasoft AI SDKs [`useChat`](/docs/api-reference/use-chat) and [`useCompletion`](/docs/api-reference/use-completion) hooks are available from the
...
You can visit the full SolidStart example [on GitHub](https://github.com/khulnasoft/ai-sdk/blob/main/examples/solidstart-openai).

## Examples

- [solidstart-openai](https://github.com/khulnasoft/ai-sdk/tree/main/examples/solidstart-openai)
