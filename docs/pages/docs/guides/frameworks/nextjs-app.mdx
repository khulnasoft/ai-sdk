...
The Khulnasoft AI SDK has been built with [Next.js App Router](https://nextjs.org/docs/app) support in mind.

## Route Handlers

Using a [Route Handler](https://nextjs.org/docs/app/building-your-application/routing/router-handlers)
for your API requests is the recommended way to use the Khulnasoft AI SDK with Next.js.

Below is a minimal route handler for using the OpenAI Chat API with the `openai` API client and the Khulnasoft AI SDK. Consult our [guides](/docs/guides) for examples of using other providers.
...
Note that using the Edge Runtime is optional but highly recommended due to [longer streaming timeouts on Khulnasoft](https://khulnasoft.com/docs/concepts/functions/edge-functions/limitations#maximum-initial-response-time), no cold starts, and lower latency.
...
- [next-openai](https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-openai)
- [next-replicate](https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-replicate)
- [next-huggingface](https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-huggingface)
- [next-langchain](https://github.com/khulnasoft/ai-sdk/tree/main/examples/next-langchain)
