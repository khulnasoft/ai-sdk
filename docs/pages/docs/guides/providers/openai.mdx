...
Khulnasoft AI SDK provides a set of utilities to make it easy to use OpenAI's API. In this guide, we'll walk through how to use the utilities to create a chat bot and a text completion app.
...
<Callout>
  ...
  `openai-edge` library because of it's compatibility with Khulnasoft Edge Runtime.
