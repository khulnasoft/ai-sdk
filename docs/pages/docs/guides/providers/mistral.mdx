...
Khulnasoft AI SDK provides a set of utilities to make it easy to use [Mistral](https://mistral.ai/)'s APIs and models. In this guide, we'll walk through how to use the utilities to create a chat bot and a text completion app.
...
Create a Next.js application and install `ai` and `@mistralai/mistralai`, the Khulnasoft AI SDK and Mistral API client respectively.
