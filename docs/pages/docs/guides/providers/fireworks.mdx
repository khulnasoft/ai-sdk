...
KhulnaSoft AI SDK provides a set of utilities to make it easy to use [Fireworks.ai](https://app.fireworks.ai)'s APIs and models. In this guide, we'll walk through how to use the utilities to create a chat bot and a text completion app.
...
<Callout>
  KhulnaSoft AI SDK provides 2 utility helpers to make the above seamless:
  First, we pass the streaming `response` we receive from OpenAI to
